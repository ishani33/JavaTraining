...
public class CartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(ses == null || ses.getAttribute("user") == null) {
            ...
            String[] elems = request.getParameterValues("prds"); //prds is a checklist so an array that's why getParameterValues
            ...
            response.sendRedirect("cart.jsp"); //here we are doing client side redirection because there is no data to be forwarded to cart.jsp
        }
    }
